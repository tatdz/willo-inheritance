...
export default function Documentation() {
  ...
  const sections = [
    ...
    { id: 'quick-start', title: 'Quick Start', icon: <Rocket className="h-4 w-4" /> },
    { id: 'key-features', title: 'Key Features', icon: <Shield className="h-4 w-4" /> },
    { id: 'technical-stack', title: 'Technical Stack', icon: <Code2 className="h-4 w-4" /> },
    { id: 'user-guide', title: 'User Guide', icon: <Users className="h-4 w-4" /> },
    { id: 'developer-guide', title: 'Developer Guide', icon: <Code2 className="h-4 w-4" /> },
    { id: 'troubleshooting', title: 'Troubleshooting', icon: <Shield className="h-4 w-4" /> },
    { id: 'roadmap', title: 'Roadmap', icon: <Rocket className="h-4 w-4" /> },
    { id: 'resources', title: 'Resources', icon: <ExternalLink className="h-4 w-4" /> }
  ];
            ...
            <nav className="space-y-2">
              {sections.map((section) => (
                <button
                  ...
                  className="flex items-center gap-3 w-full text-left px-3 py-2 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors"
                >
                  {section.icon}
                  {section.title}
                </button>
          ...
          <Card id="roadmap">
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <ul className="space-y-1 text-sm text-gray-600 ml-5">
                  <li>🔄 Advanced guardian system with multi-signature</li>
                  <li>🔄 Real-time price tracking and alerts</li>
                  <li>🔄 Automated email notifications</li>
                  <li>🔄 Document encryption and IPFS storage</li>
                  <li>🔄 Mobile-responsive interface improvements</li>
                </ul>
              </div>
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-lg font-semibold">Phase 3: Advanced Platform (Planned)</h3>
                </div>
                <ul className="space-y-1 text-sm text-gray-600 ml-5">
            ...
            <CardContent>
                ...
                {resources.map((resource, index) => (
                  <Card key={index} className="p-4">
                    ...
                    <Button 
                      ...
                      className="w-full"
                    >
                      Visit {resource.external && <ExternalLink className="h-3 w-3 ml-1" />}
                    </Button>
                  </Card>
                ))}
              </div>
              ...
              <div className="text-center">
                ...
                <div className="flex gap-3 justify-center">
                  <Button 
                    onClick={() => window.open('https://github.com/tatdz/willo-inheritance', '_blank')}
                  >
